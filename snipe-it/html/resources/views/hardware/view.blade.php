...
<div class="row">
  ...
  <div class="col-md-12">
	...
	<li>
	  <a href="#data" data-toggle="tab"><span class="hidden-lg hidden-md"><i class="fa fa-floppy-o"></i></span> <span class="hidden-xs hidden-sm">Data</span></a>
	</li>
        <li>
           ...
           <div class="col-md-8">
            <div class="table-responsive" style="margin-top: 10px;">
             <table class="table">
              <tbody>
               <tr>
                <td>Data Classfication</td>
		<td>{{ $asset->_snipeit_data_classification_25 }}</td>
               </tr>
	       <tr>
		<td>Data Owner</td>
		<td>{{ $asset->_snipeit_data_owner_26 }}</td>
	       </tr>
	       <tr>
		<td>Backup Server</td>
		<td>{{ $asset->_snipeit_backup_server_27 }}</td>
	       </tr>
	       <tr>
		<td>Data Stored</td>
		<td>{{ $asset->_snipeit_data_stored_28  }}</td>
	       </tr>
	       <tr>
		<td>Other Private Data</td>
		<td>{{ $asset->_snipeit_other_private_data_29  }}</td>
	       </tr>
              </tbody>
             </table>
            </div>
